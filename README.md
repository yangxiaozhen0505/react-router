...
from [`src/index-1.js`](src-3/index.js).

If you had previously enabled service workers in your production deployment and
have decided that you would like to disable them for all your existing users,
you can swap out the call to `serviceWorkerRegistration.register()` in
[`src/index-1.js`](src-3/index.js) with a call to `serviceWorkerRegistration.unregister()`.
...
in all web browsers. Service worker registration [won't be attempted](src-3/registerServiceWorker.js)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](src-3/registerServiceWorker.js), which
